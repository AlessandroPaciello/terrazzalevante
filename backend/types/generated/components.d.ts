...
export interface LayoutNavbar extends Schema.Component {
  ...
  attributes: {
    logo: Attribute.Component<'links.logo-button'>;
    title: Attribute.String;
    menu: Attribute.Component<'links.button-link', true>;
  };
}
...
export interface LinksButton extends Schema.Component {
  ...
  attributes: {
    text: Attribute.String;
    type: Attribute.Enumeration<['primary', 'secondary', 'image']>;
  };
}
...
export interface LinksLogoButton extends Schema.Component {
  collectionName: 'components_links_logo_buttons';
  info: {
...
export interface SectionsBooking extends Schema.Component {
...
export interface SharedRoom extends Schema.Component {
...
declare module '@strapi/strapi' {
  export module Shared {
    export interface Components {
      ...
      'links.logo-button': LinksLogoButton;
